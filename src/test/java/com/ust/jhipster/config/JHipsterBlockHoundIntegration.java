package com.ust.jhipster.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ust.jhipster.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ust.jhipster.security.DomainUserDetailsService", "createSpringSecurityUser");
